...
binary_phase = closing(binary_phase, square(3))  # Use a 3x3 square structuring element
# 2. Opening: Removes small objects
binary_phase = opening(binary_phase, square(3))  # Use a 3x3 square structuring element
